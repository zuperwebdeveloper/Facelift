      ...
      (e.advance = function (t) {
        ...
        if (this.isRunning) {
          ...
          if (this.lerp)
            ...
            this.currentTime += t;
            var s = i(0, this.currentTime / this.duration, 1),
        ...
        (this.onWindowResize = function () {
          ...
          this.wrapper === window
            ...
            : ((this.wrapperResizeObserver = new ResizeObserver(
                n(this.onWrapperResize, 100)
              )),
              this.wrapperResizeObserver.observe(this.wrapper),
              this.onWrapperResize()),
          (this.contentResizeObserver = new ResizeObserver(
            n(this.onContentResize, 100)
          )),
        ...
        (this.onTouchStart = function (t) {
          ...
          (this.onTouchMove = function (t) {
            var e = t.targetTouches ? t.targetTouches[0] : t,
              i = e.pageX,
              n = e.pageY,
              s = -(i - o.touchStart.x) * o.touchMultiplier,
              r = -(n - o.touchStart.y) * o.touchMultiplier;
            (o.touchStart.x = i),
              (o.touchStart.y = n),
          ...
          (this.onWheel = function (t) {
            var e = t.deltaX,
              n = t.deltaY;
            o.normalizeWheel && ((e = i(-100, e, 100)), (n = i(-100, n, 100))),
              o.emitter.emit("scroll", {
                type: "wheel",
    ...
    l = /*#__PURE__*/ (function () {
      function t(t) {
        var e = this,
          ...
          u = void 0 === c ? window : c,
          p = i.content,
          d = void 0 === p ? document.documentElement : p,
          v = i.wheelEventsTarget,
          m = void 0 === v ? u : v,
          f = i.smoothWheel,
          g = void 0 === f ? null == a || a : f,
          w = i.smoothTouch,
          S = void 0 !== w && w,
          y = i.duration,
          z = i.easing,
          b =
            void 0 === z
              ...
              : z,
          M = i.lerp,
          T = void 0 === M ? (y ? null : 0.1) : M,
          E = i.infinite,
          L = void 0 !== E && E,
          W = i.orientation,
          R = void 0 === W ? (null != n ? n : "vertical") : W,
          _ = i.gestureOrientation,
          O = void 0 === _ ? (null != l ? l : "vertical") : _,
          k = i.touchMultiplier,
          H = void 0 === k ? 2 : k,
          x = i.wheelMultiplier,
          C = void 0 === x ? (null != h ? h : 1) : x,
          X = i.normalizeWheel,
          Y = void 0 !== X && X;
        (this.onVirtualScroll = function (t) {
          ...
          if (
            ...
            !(
              ...
              s.composedPath().find(function (t) {
            ...
            if (e.isStopped || e.isLocked) s.preventDefault();
              ...
              if (
                ((e.isSmooth =
                  (e.options.smoothTouch && "touch" === i) ||
                  (e.options.smoothWheel && "wheel" === i)),
                !e.isSmooth)
              )
              ...
              "both" === e.options.gestureOrientation
                ...
                : "horizontal" === e.options.gestureOrientation && (r = o),
                e.scrollTo(e.targetScroll + r, { programmatic: !1 });
            }
        }),
            ...
            if ("number" == typeof t) {
              if (
                ...
                this.options.infinite
                  ? z && (this.targetScroll = this.animatedScroll = this.scroll)
                  : (t = i(0, t, this.limit)),
                h)
              )
                return (
